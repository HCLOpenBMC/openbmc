...
PACKAGECONFIG[multi-purpose-monitor] = "-Dmulti-purpose-monitor=enabled, -Dmulti-purpose-monitor=disabled"
PACKAGECONFIG[fru-fault-monitor] = "-Dfru-fault-monitor=enabled, -Dfru-fault-monitor=disabled"
