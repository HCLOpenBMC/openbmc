UMMARY = "Phosphor post code manager"
...
python () {
    ...
    d.setVar('VAR', " ".join(["xyz.openbmc_project.State.Boot.PostCode@{}.service".format(x) for x in d.getVar('OBMC_HOST_INSTANCES').split()]))
